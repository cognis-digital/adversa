"""Native cognis-connect emit for adversa — forward findings to any platform.

Maps adversa's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    adversa ... --format json | adversa-emit --to stix
    adversa-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
