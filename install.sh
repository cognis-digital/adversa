#!/usr/bin/env sh
# Universal installer for adversa. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/adversa.git"
echo "Installing adversa ..."
